...
T = typing.TypeVar('T', bound='CheckLoad')
...
class CheckLoad(CheckSNMP):
    ...
    def create(id: str, force_create: bool = False) -> T:
        ...
        if None is ConfigBuilder.get_command('monitoring_plugins_snmp_ucd_snmp_mib_load'):
            LoadCommand.create('monitoring_plugins_snmp_ucd_snmp_mib_load')
