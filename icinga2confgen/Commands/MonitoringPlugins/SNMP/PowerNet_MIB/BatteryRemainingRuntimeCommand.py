...
T = typing.TypeVar('T', bound='BatteryRemainingRuntimeCommand')


class BatteryRemainingRuntimeCommand(SNMPCommand):
    ...
    def create(id: str, force_create: bool = False) -> T:
        ...
        if None is command:
            command = BatteryRemainingRuntimeCommand(id)
            ConfigBuilder.add_command(id, command)
        elif not isinstance(command, BatteryRemainingRuntimeCommand):
            raise Exception(
                'Id must be for an instance of BatteryRemainingRuntimeCommand but other instance is returned')
