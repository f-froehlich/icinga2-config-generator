...
T = typing.TypeVar('T', bound='SpaceIOCommand')


class SpaceIOCommand(SNMPCommand):
    ...
    def create(id: str, force_create: bool = False):
        ...
        if None is command:
            command = SpaceIOCommand(id)
            ConfigBuilder.add_command(id, command)
        elif not isinstance(command, SpaceIOCommand):
            raise Exception('Id must be for an instance of SpaceIOCommand but other instance is returned')
