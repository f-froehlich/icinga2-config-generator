...
T = typing.TypeVar('T', bound='StorageIOCommand')


class StorageIOCommand(SNMPCommand):
    ...
    def create(id: str, force_create: bool = False):
        ...
        if None is command:
            command = StorageIOCommand(id)
            ConfigBuilder.add_command(id, command)
        elif not isinstance(command, StorageIOCommand):
            raise Exception('Id must be for an instance of StorageIOCommand but other instance is returned')
